...
// Sistema de notificações com seleção automática de idioma por página
...
function getNotificationLocale() {
    ...
    if (htmlLang.startsWith('pt') || currentPath === '/br' || currentPath.startsWith('/br/')) {
        return 'pt';
    }
    return 'es';
}

const notificationLocale = getNotificationLocale();
const notificationConfig = NOTIFICATION_I18N[notificationLocale] || NOTIFICATION_I18N.es;
const notificationMessages = notificationConfig.messages;
...
function createNotification(notification) {
    ...
    notificationEl.innerHTML = `
        ...
        <div class="notification-content">
            ...
            <div class="notification-product">${notificationConfig.purchaseLabel}: ${notification.product}</div>
